...
(
    ...
    CONSTRAINT FK_REQUESTS_ON_REQUESTER FOREIGN KEY (requester) REFERENCES users (id)
);
...
(
    ...
    CONSTRAINT FK_ITEMS_ON_REQUESTS FOREIGN KEY (request) REFERENCES requests (id)
);
